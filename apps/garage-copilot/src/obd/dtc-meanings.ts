...
export const DTC_MEANINGS: Record<string, Record<string, DtcMeaning>> = {
  GENERIC: {
    ...
    P0171: {
      ...
      systems: ["fuel"],
      commonCauses: ["Vacuum leak", "Fuel pressure low", "MAF sensor dirty", "Fuel injector stuck open"],
      likelihood: "common"
    },
    P0172: {
      code: "P0172",
    ...
    P0300: {
      ...
      commonCauses: ["Spark plugs worn", "Ignition coils failing", "Fuel pressure low", "Vacuum leak"],
      likelihood: "common"
    },
    P0301: {
      code: "P0301",
  ...
  Toyota: {
    P0133: {
      code: "P0133",
      description: "O2 Sensor Circuit Slow Response (Bank 1, Sensor 1)",
      commonCauses: ["O2 sensor aging", "Exhaust leak before sensor", "Catalyst efficiency declining"],
      likelihood: "common"
    },
    P0155: {
      code: "P0155",
  ...
  Honda: {
    ...
    P0171: {
      ...
      systems: ["fuel"],
      commonCauses: ["Vacuum leak", "Fuel pressure low", "MAF sensor dirty", "Leaking fuel injector"],
      likelihood: "common"
    },
    P0172: {
      code: "P0172",
      ...
      systems: ["fuel"],
      commonCauses: ["Fuel pressure too high", "Injector stuck open", "O2 sensor failing", "Air intake leak"],
      likelihood: "common"
    },
    P1128: {
      code: "P1128",
  ...
  Ford: {
    ...
    P0171: {
      ...
      description: "System Too Lean (Bank 1)",
      systems: ["fuel"],
      commonCauses: ["Vacuum leak", "Fuel filter clogged", "MAF sensor contaminated", "O2 sensor failure"],
      likelihood: "common"
    },
    P0172: {
      code: "P0172",
      description: "System Too Rich (Bank 1)",
      systems: ["fuel"],
      commonCauses: ["Fuel pressure too high", "Injector leaking", "MAF sensor failure", "O2 sensor stuck"],
      likelihood: "common"
    },
    P1000: {
      code: "P1000",
  ...
  GM: {
    P0133: {
      code: "P0133",
      description: "O2 Sensor Circuit Slow Response (Bank 1, Sensor 1)",
      commonCauses: ["O2 sensor degradation", "Exhaust temperature too low", "Catalyst deterioration"],
      likelihood: "common"
    },
    P0171: {
      code: "P0171",
  ...
  BMW: {
    ...
    P0171: {
      ...
      systems: ["fuel"],
      commonCauses: ["Vacuum leak", "Fuel pressure too low", "MAF sensor fault", "Fuel filter clogged"],
      likelihood: "common"
    },
    P0172: {
      code: "P0172",
  ...
  Audi: {
    ...
    P0171: {
      ...
      systems: ["fuel"],
      commonCauses: ["Air leak in intake", "Fuel pressure low", "MAF sensor fault", "Fuel filter clogged"],
      likelihood: "common"
    },
    P0172: {
      code: "P0172",
  ...
  Nissan: {
    P0133: {
      code: "P0133",
      description: "O2 Sensor Circuit Slow Response (Bank 1, Sensor 1)",
      commonCauses: ["O2 sensor end-of-life", "Exhaust leak before sensor", "Catalyst efficiency declining"],
      likelihood: "common"
    },
    P0171: {
      code: "P0171",
